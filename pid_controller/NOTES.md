...
4. Finally, the sign of the computed throttle ouput is used to determine if the output should be interpreted as a true 'throttle' command, or a 'brake' command instead. 
``` c++
...
1. Question: *Add the plots to your report and explain them (describe what you see).*  
   ...
   **Steer Control**  
   ...
   ![steer control](./screenshot/steer_controller.png)
   ...
   **Throttle Control**
   ...
   ![alt text](./screenshot/throttle_controller.png)
